...
const drawer=floatingAction('☰  Controls','Look and hold 10 seconds',1.55);drawer.userData.action=expandControls;drawer.userData.dwellMs=10000;
const bringPrompt=floatingAction('◎  Bring video here','Press headset button or look and hold',2.15);bringPrompt.material.opacity=.68;bringPrompt.userData.action=bringVideoHere;bringPrompt.userData.dwellMs=900;
