...
function makeLabel(icon,text,action,x,width=.62){
  ...
  const grad=g.createLinearGradient(0,0,0,176);grad.addColorStop(0,'#25282e');grad.addColorStop(1,'#15171b');g.fillStyle=grad;g.roundRect(12,12,488,152,28);g.fill();g.strokeStyle='#ffffff38';g.lineWidth=3;g.stroke();
  g.fillStyle='#e8e9eb';g.font='600 40px system-ui';g.textAlign='center';g.textBaseline='middle';g.fillText(icon,76,88);g.fillStyle='#f4f4f5';g.font='600 32px system-ui';g.fillText(text,308,88);
